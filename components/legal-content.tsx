...
export function PrivacyContent() {
  return (
    <LegalModal
      ...
      trigger={
        <span className="text-sm text-gray-400 hover:text-[#f8b5c1] transition-colors cursor-pointer">
          Datenschutz
        </span>
      }
    >
      <div className="space-y-6">
        <section>
          <h3 className="text-md font-medium text-[#f8b5c1] mb-2">Allgemeine Hinweise</h3>
          <p className="mb-4">
        ...
        <section>
          <h3 className="text-md font-medium text-[#f8b5c1] mb-2">Datenerfassung auf dieser Website</h3>
          <p className="mb-4">
        ...
        <section>
          <h3 className="text-md font-medium text-[#f8b5c1] mb-2">Wie erfassen wir Ihre Daten?</h3>
          <p className="mb-4">
        ...
        <section>
          <h3 className="text-md font-medium text-[#f8b5c1] mb-2">Wofür nutzen wir Ihre Daten?</h3>
          <p className="mb-4">
        ...
        <section>
          <h3 className="text-md font-medium text-[#f8b5c1] mb-2">Welche Rechte haben Sie bezüglich Ihrer Daten?</h3>
          <p className="mb-4">
...
export function TermsContent() {
  return (
    ...
    >
      <div className="space-y-6">
        <section>
          <h3 className="text-md font-medium text-[#f8b5c1] mb-2">1. Allgemeine Bestimmungen</h3>
          <p className="mb-4">
        ...
        <section>
          <h3 className="text-md font-medium text-[#f8b5c1] mb-2">2. Zweck der Website</h3>
          <p className="mb-4">
        ...
        <section>
          <h3 className="text-md font-medium text-[#f8b5c1] mb-2">3. Haftungsausschluss</h3>
          <p className="mb-4">
        ...
        <section>
          <h3 className="text-md font-medium text-[#f8b5c1] mb-2">4. Urheberrecht</h3>
          <p className="mb-4">
        ...
        <section>
          <h3 className="text-md font-medium text-[#f8b5c1] mb-2">5. Änderungen</h3>
          <p className="mb-4">
  ...
  return (
    ...
    >
      <div className="space-y-6">
        ...
        <section>
          <h3 className="text-md font-medium text-[#f8b5c1] mb-2">Kontakt</h3>
          <div className="space-y-2">
        ...
        <section>
          <h3 className="text-md font-medium text-[#f8b5c1] mb-2">Umsatzsteuer-ID</h3>
          <p>Umsatzsteuer-Identifikationsnummer gemäß § 27 a Umsatzsteuergesetz: [USt-IdNr.]</p>
        </section>

        <section>
          <h3 className="text-md font-medium text-[#f8b5c1] mb-2">Verantwortlich für den Inhalt nach § 55 Abs. 2 RStV</h3>
  ...
  return (
    ...
    >
      <div className="space-y-6">
        ...
        <section>
          <h3 className="text-md font-medium text-[#f8b5c1] mb-2">1. Recht auf Information</h3>
          <p className="mb-4">
        ...
        <section>
          <h3 className="text-md font-medium text-[#f8b5c1] mb-2">2. Recht auf Selbstbestimmung</h3>
          <p className="mb-4">
        ...
        <section>
          <h3 className="text-md font-medium text-[#f8b5c1] mb-2">3. Schweigepflicht</h3>
          <p className="mb-4">
        ...
        <section>
          <h3 className="text-md font-medium text-[#f8b5c1] mb-2">4. Recht auf Einsicht in die Patientenakte</h3>
          <p className="mb-4">
        ...
        <section>
          <h3 className="text-md font-medium text-[#f8b5c1] mb-2">5. Recht auf eine zweite Meinung</h3>
          <p className="mb-4">
        ...
        <section>
          <h3 className="text-md font-medium text-[#f8b5c1] mb-2">6. Beschwerderecht</h3>
          <p className="mb-4">
